...
if __name__ == "__main__":
    inference_dir = "/pscratch/sd/t/timothys/nested-eagle/1.00deg-15km/mse06h/experiments/trim-lam-edge/trim20-win4320/inference"
    ...
    main(
        ...
        tf="2023-03-10T00",
        mode="figure",
        trim_lam_edge=[20, 21, 20, 21],
        name="csmswt-trim20-win4320",
    )
    main(
        read_path=f"{inference_dir}/2023-03-09T00.240h.nc",
        store_dir=inference_dir,
